...
ENTRIES = [
    ...
    ("advancedMore", "Further advanced tools will appear here as they are ready.", "更多高级工具将在准备就绪后出现在这里。", "さらなる詳細設定は準備が整い次第ここに追加されます。", "추가 고급 도구는 준비되는 대로 여기에 표시됩니다."),
