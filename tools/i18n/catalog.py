...
ENTRIES = [
    ...
    ("notebookDetailEmpty", "Nothing in this notebook yet. Select notes or tasks on the Notes or Tasks page and add them here.", "这个笔记本还没有内容。到“笔记”或“任务”页选中内容，然后加入这里。", "このノートブックにはまだ項目がありません。「ノート」や「タスク」のページで選択して追加してください。", "이 노트북에는 아직 항목이 없습니다. 노트 또는 할 일 페이지에서 항목을 선택해 여기에 추가하세요."),
