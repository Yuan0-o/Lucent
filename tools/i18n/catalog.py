...
ENTRIES = [
    ...
    ("themeMonetAbyssDesc", "A deep teal abyss dark.", "深邃青绿深渊暗色。", "深いティールのアビスのダークテーマ。", "깊은 틸 어비스 다크 테마."),
    ("themeMonetBlueberry", "Blueberry", "蓝莓", "ブルーベリー", "블루베리"),
    ("themeMonetBlueberryDesc", "A rich blueberry dark.", "浓郁蓝莓暗色。", "濃いブルーベリーのダークテーマ。", "진한 블루베리 다크 테마."),
    ("themeMonetBrick", "Brick", "砖红", "ブリック", "브릭"),
    ("themeMonetBrickDesc", "A deep brick-red dark.", "深砖红暗色。", "深いレンガ色のダークテーマ。", "깊은 브릭 레드 다크 테마."),
    ("themeMonetClay", "Clay", "陶土", "クレイ", "클레이"),
    ("themeMonetClayDesc", "A warm burnt-umber dark.", "温暖的焦赭深色。", "暖かなバーントアンバーのダークテーマ。", "따뜻한 번트 엠버 다크 테마."),
    ("themeMonetCoral", "Coral", "珊瑚", "コーラル", "코랄"),
    ("themeMonetCoralDesc", "A warm coral light.", "温暖珊瑚浅色。", "あたたかいコーラルのライトテーマ。", "따뜻한 코랄 라이트 테마."),
    ("themeMonetDeepMoss", "Deep Moss", "深苔", "ディープモス", "딥 모스"),
    ("themeMonetDeepMossDesc", "A deep mossy green dark.", "深苔绿暗色。", "深いコケグリーンのダークテーマ。", "깊은 이끼 그린 다크 테마."),
    ("themeMonetFir", "Fir", "冷杉", "モミ", "전나무"),
    ("themeMonetFirDesc", "A deep fir-green dark.", "深冷杉绿暗色。", "深いモミグリーンのダークテーマ。", "깊은 전나무 그린 다크 테마."),
    ("themeMonetFrost", "Frost", "霜", "フロスト", "프로스트"),
    ("themeMonetFrostDesc", "A cool frost-blue light.", "清冷霜蓝浅色。", "涼しげなフロストブルーのライトテーマ。", "시원한 프로스트 블루 라이트 테마."),
    ("themeMonetHoney", "Honey", "蜂蜜", "ハニー", "허니"),
    ("themeMonetHoneyDesc", "A warm golden-cream light.", "温暖的金奶油色浅色。", "やわらかなゴールドクリームのライトテーマ。", "따뜻한 골든 크림 라이트 테마."),
    ("themeMonetHoneydew", "Honeydew", "蜜瓜", "ハニーデュー", "허니듀"),
    ("themeMonetHoneydewDesc", "A fresh melon-green light.", "清新蜜瓜绿浅色。", "さわやかなメロングリーンのライトテーマ。", "상쾌한 멜론 그린 라이트 테마."),
    ("themeMonetLinen", "Linen", "亚麻", "リネン", "리넨"),
    ("themeMonetLinenDesc", "A pale linen light.", "淡亚麻浅色。", "淡いリネンのライトテーマ。", "연한 리넨 라이트 테마."),
    ("themeMonetMint", "Mint", "薄荷", "ミント", "민트"),
    ("themeMonetMintDesc", "A soft mint light.", "柔和薄荷浅色。", "やわらかなミントのライトテーマ。", "부드러운 민트 라이트 테마."),
    ("themeMonetObsidian", "Obsidian", "黑曜石", "オブシディアン", "옵시디언"),
    ("themeMonetObsidianDesc", "A deep blue-grey obsidian dark.", "深蓝灰黑曜石暗色。", "深い青灰オブシディアンのダークテーマ。", "깊은 블루그레이 옵시디언 다크 테마."),
    ("themeMonetOrchid", "Orchid", "兰花", "オーキッド", "오키드"),
    ("themeMonetOrchidDesc", "A soft mauve light.", "柔和的紫粉浅色。", "やわらかなモーヴのライトテーマ。", "부드러운 모브 라이트 테마."),
    ("themeMonetOrchidNight", "Orchid Night", "兰花之夜", "オーキッドナイト", "오키드 나이트"),
    ("themeMonetOrchidNightDesc", "A deep mauve dark.", "深紫褐的暗色。", "深いモーヴのダークテーマ。", "깊은 모브 다크 테마."),
    ("themeMonetPeach", "Peach", "蜜桃", "ピーチ", "피치"),
    ("themeMonetPeachDesc", "A soft apricot light.", "柔和的杏色浅色。", "やわらかなアプリコットのライトテーマ。", "부드러운 살구색 라이트 테마."),
    ("themeMonetPeriwinkle", "Periwinkle", "长春花", "ペリウィンクル", "페리윙클"),
    ("themeMonetPeriwinkleDesc", "A gentle blue-violet light.", "柔和蓝紫浅色。", "やさしい青紫のライトテーマ。", "은은한 블루 바이올렛 라이트 테마."),
    ("themeMonetSnowdrop", "Snowdrop", "雪滴", "スノードロップ", "스노드롭"),
    ("themeMonetSnowdropDesc", "An icy near-white light.", "冰冷近白浅色。", "氷のように白いライトテーマ。", "차가운 아이스 화이트 라이트 테마."),
    ("themeMonetUmber", "Umber", "赭色", "アンバー", "엄버"),
    ("themeMonetUmberDesc", "A deep burnt-umber dark.", "深焦赭色暗色。", "深いバーントアンバーのダークテーマ。", "깊은 번트 엄버 다크 테마."),
    ("themeMonetWalnut", "Walnut", "胡桃", "ウォールナット", "호두"),
    ("themeMonetWalnutDesc", "A rich walnut-brown dark.", "浓郁胡桃棕暗色。", "豊かなウォールナットブラウンのダークテーマ。", "풍부한 호두 브라운 다크 테마."),
