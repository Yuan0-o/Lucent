...
ENTRIES = [
    ...
    ("themeSectionSystem", "Follow system", "跟随系统", "システムに従う", "시스템 따르기"),
    ...
    ("dynamicColorGradientNote", "While the animated background is on, these wallpaper colours also paint the full-screen diffuse gradient — not just the flat theme colour.", "开启动态背景时，这些壁纸取色不仅用于纯色主题，也会用于全屏弥散渐变。", "アニメーション背景がオンのとき、この壁紙の色は単色テーマだけでなく全画面の拡散グラデーションにも使われます。", "애니메이션 배경이 켜져 있으면 이 배경화면 색이 단색 테마뿐 아니라 전체 화면 확산 그라데이션에도 사용됩니다."),
