...
ENTRIES = [
    ...
    ("reasoningTitleCustom", "Reasoning effort (custom endpoint)", "推理程度（自定义接口）", "推論の程度（カスタム接続先）", "추론 수준(사용자 지정 엔드포인트)"),
    ...
    ("reasoningFixedByProvider", "This provider has no reasoning-effort parameter.", "该服务商没有推理程度参数。", "このプロバイダーに推論程度のパラメータはありません。", "이 제공자에는 추론 수준 파라미터가 없습니다."),
    ("reasoningCustomHint", "Sent as reasoning_effort; some compatible endpoints ignore it.", "以 reasoning_effort 发送；部分兼容接口会忽略它。", "reasoning_effort として送信します。互換エンドポイントによっては無視されます。", "reasoning_effort로 전송하며, 일부 호환 엔드포인트는 무시합니다."),
